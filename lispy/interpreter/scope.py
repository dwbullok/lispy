from codeviking.contracts import check_sig, contracts
from codeviking.contracts.types import NamedTuple

from .error import VarNameNotFoundError
from ..common import TokenPos, Syn, AstNode, ArgExpr
...
class Scope(object):
    ...
    def __init__(self, pos: TokenPos, parent: 'Scope'=None):
        """
    ...
    def make_child_scope(self, pos:TokenPos) -> 'Scope':
