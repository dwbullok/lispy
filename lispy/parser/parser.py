...
from ..common import Syn, AstNode
from .error import UnclosedExpressionError, TooManyClosingParensError
from codeviking.contracts import check_sig, Seq
...
class Parser(object):
    ...
    @check_sig
    def parse(self, tokens: Seq({Syn,AstNode})):
        """
    ...
    def make_ast_node(self, exprs):
        ...
        :type exprs: list[Syn or AstNode]
    ...
    def is_expr(self, item):
        ...
        :rtype: bool
        """
        return item.stype in self.expr_types
